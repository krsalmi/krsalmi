...
I've been working as a software engineer for over 4 years, and I'm also part of the [Hive Helsinki](https://www.hive.fi/en/) alumni. I enjoy building stuff. I'm curious about AI and I've been studying the fundamentals on my own. I've been a winner in all 3 hackatons I participated in, all in the last 1.5 years.

## Some projects...  

- [HealthPlan AI](https://www.findhealthplan.ai) My main focus at the moment. An AI voice assistant that helps users find and understand suitable health insurance plans on the ACA marketplace. Please give it a try, feedback/critique appreciated! Share with anyone you know who's looking for health insurance in the US. Not all states are covered, but I hope to add more soon. The early prototype of this project won 10th place out of 130,000 participants in the 'World's Largest Hackathon' organized by Bolt. Current stack: Vite/Typescript, node Fastify backend, ElevenLabs conversational AI agent, Gemini LLM model, CMS API for realtime data. Deployed on Netlify and AWS.
  
- [Your Tiny Tale](https://yourtinytale.com) A web app for parents to order hyper personalized stories for their kids. Currently pivoting from PDFs to physical books per users' requests. Webflow website, embedded iframe to app: NodeJS/React, Supabase, Vercel, OpenAI and Gemini API, Stripe for payments. N8N for automation.
...
- [LinkedIn](www.linkedin.com/in/kristiina-salmi)
